...
Original file is located at
    https://colab.research.google.com/drive/1-JQh9jCrOuDrWCP-y9W7K3IrJEkS7wxl
...
def jacobi1_method(n):
    ...
    y_n=0
    # Put your code here.
    new_list=jacobi1_iteration(x_n,y_n)
    for i in range(n-1):
      new_list=jacobi1_iteration(new_list[0],new_list[1])
...
def gs1_method(n): 
    ...
    y_n=0
    # Put your code here.
    new_list=gs1_iteration(x_n,y_n)
    for i in range(n-1):
      new_list=gs1_iteration(new_list[0],new_list[1])
    return new_list # Your return statement should return a list of the form [x_n,y_n]
...
def gs1_error(n): 
    ...
    list1=[x_val,y_val]
    list2=gs1_method(n)
    return np.linalg.norm(np.array(list1)-np.array(list2)) # Put your return statement here.
...
def gs2_method(n): 
    ...
    y_n=0
    # Put your code here.
    new_list=gs2_iteration(x_n,y_n)
    for i in range(n-1):
      new_list=gs2_iteration(new_list[0],new_list[1])
    return new_list # Your return statement should return a list of the form [x_n,y_n]
...
def gs3_method(n): 
    ...
    z_n=0
    # Put your code here.
    new_list=gs3_iteration(x_n,y_n,z_n)
    for i in range(n-1):
      new_list=gs3_iteration(new_list[0],new_list[1],new_list[2])
